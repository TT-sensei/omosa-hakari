...
function start(max){maxWeight=max;step=SCALES[max].step;renderBook();$('scaleLabel').textContent=SCALES[max].name+'　1めもり '+step+'g';$('start').classList.add('hidden');$('app').classList.remove('hidden');buildDial();spawn()}
